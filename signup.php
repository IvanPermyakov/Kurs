...
<?php require "blocks/header.php" ?>
	...
	<div class="container mt-5">
		...
		<form action ="forms/reg.php" method="post">
			...
			<input type = "text" class="form-control mt-2" name="name" id="name" placeholder="Введите имя" >
			<input type = "password" class="form-control mt-2" name="pass" id="pass" placeholder="Введите пароль" >

			<button type="submit" name="send" class="btn btn-success mt-2" >Зарегистрировать</button>
		</form>
	</div>
